...
---- Azuregos
	...
	AtlasLoot_Data["AVBlue_H"] = {
		...
		Back = "PVPMENU2";
			...
			AtlasLoot_Data["OtherPvPRewards"] = {
		{ 1, 29465, "", "=q4=Black Battlestrider", "=ds=#e12#", "3000 #alliance#", ""};
		{ 2, 29467, "", "=q4=Black War Ram", "=ds=#e12#", "3000 #alliance#", ""};
		{ 3, 29468, "", "=q4=Black War Steed Bridle", "=ds=#e12#", "3000 #alliance#", ""};
		{ 4, 29471, "", "=q4=Reins of the Black War Tiger", "=ds=#e12#", "3000 #alliance#", ""};
		{ 5, 35906, "", "=q4=Reins of the Black War Elekk", "=ds#e12#=", "3000 #alliance#", ""};
		{ 16, 29466, "", "=q4=Black War Kodo", "=ds=#e12#", "3000 #horde#", ""};
		{ 17, 29469, "", "=q4=Horn of the Black War Wolf", "=ds=#e12#", "3000 #horde#", ""};
		{ 18, 29470, "", "=q4=Red Skeletal Warhorse", "=ds=#e12#", "3000 #horde#", ""};
		{ 19, 29472, "", "=q4=Whistle of the Black War Raptor", "=ds=#e12#", "3000 #horde#", ""};
		{ 20, 34129, "", "=q4=Swift Warstrider", "=ds=#e12#", "3000 #horde#", ""};
		Prev = "VentureBay1";
		Next = "PvP80Misc";
		Back = "PVPMENU2";
	};
