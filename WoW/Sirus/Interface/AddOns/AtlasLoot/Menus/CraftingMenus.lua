...
local BabbleZone = AtlasLoot_GetLocaleLibBabble("LibBabble-Zone-3.0")
	...
	AtlasLoot_Data["JEWELCRAFTINGMENU"] = {
		...
		{ 10, "ChimerasEye", "INV_Misc_Gem_01", "=ds="..AL["Chimera's Eye"], "" };
	...
	AtlasLoot_Data["LEATHERWORKINGMENU"] = {
		...
		{ 12, "Elemental1", "INV_Misc_ArmorKit_17", "=ds="..GetSpellInfo(10658), "" };
	...
	AtlasLoot_Data["TAILORINGMENU"] = {
		...
		{ 8, "Spellfire1", "Trade_Tailoring", "=ds="..GetSpellInfo(26797), "" };
