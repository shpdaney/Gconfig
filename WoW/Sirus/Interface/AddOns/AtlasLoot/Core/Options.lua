...
getglobal("AtlasLootHelpFrame_HelpTextFrameScroll"):SetWidth(ALframewidth-45) --panel3 width
getglobal("AtlasLootHelpFrame_HelpTextFrameScroll"):SetHeight(ALframeheight-45) --panel3 height
getglobal("AtlasLootHelpFrame_HelpTextFrame"):SetWidth(ALframewidth-45) --scc width
getglobal("AtlasLootHelpFrame_HelpTextFrame"):SetHeight(ALframeheight-45) --scc height
getglobal("AtlasLootHelpFrame_HelpText"):SetWidth(ALframewidth-45) --text width
end
