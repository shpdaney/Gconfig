...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 266 $"):match("%d+"))
...
lib:SetBaseTranslations {
	...
	["Serpentshrine Cavern 10"] = "Serpentshrine Cavern 10",
	...
	["Tempest Keep 10"] = "Tempest Keep 10",
...
elseif GAME_LOCALE == "ruRU" then
	...
	["Serpentshrine Cavern 10"] = "Змеиное святилище 10",
	...
	["Tempest Keep 10"] = "Крепость Бурь 10",
