...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 286 $"):match("%d+"))
...
elseif GAME_LOCALE == "ruRU" then
	...
	["Saviana Ragefire"] = "Савиана Огненная пасть",
	...
	["Jaina Proudmoore"] = "Леди Джайна Праудмур (25 Гер)",
