...
elseif GAME_LOCALE == "ruRU" then
	L["About"] = "Об аддоне"
	L["Click and press Ctrl-C to copy"] = "Кликните и нажмите Ctrl-C чтобы скопировать"
	L["Version"] = "Версия"
	L["Author"] = "Авторы"
	L["X-Category"] = "Категория"
	L["X-License"] = "Лицензия"
	L["X-Email"] = "Почта"
	L["X-Website"] = "Сайт"
	L["X-Credits"] = "Спасибо"
-- zhCN
...
function lib.OnShow(frame)
	...
	for _,field in pairs(fields) do
		...
		if val then
			...
			else title:SetPoint("TOPLEFT", anchor, "BOTTOMLEFT", 0, -25) end
			...
			local haseditbox = {["Сайт"] = true, ["Почта"] = true, ["X-Donate"] = true, ["Email"] = true, ["eMail"] = true}

			local detail = frame:CreateFontString(nil, "ARTWORK", "GameFontHighlightSmall")
			detail:SetFont("Fonts\\FRIZQT__.TTF", 12)
			detail:SetHeight(32)
