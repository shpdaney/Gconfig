...
if AL then
    ...
    AL["Level 60 and 70"] = "Уровень 60 и 70";
	AL["Level 80"] = "Уровень 80";
	AL["7 kata"] = "7 Категория";
	AL["7+ kata"] = "7+ Категория";
	AL["6 kata"] = "6 Категория";
	AL["6+ kata"] = "6+ Категория";
	AL["6++ kata"] = "6++ Категория";
	AL["5 kata"] = "5 Категория";
	AL["5+ kata"] = "5+ Категория";
	AL["5++ kata"] = "5++ Категория";
	AL["5+++ kata"] = "5+++ Категория";
	AL["4 kata"] = "4 Категория";
	AL["4+ kata"] = "4+ Категория";
	AL["4++ kata"] = "4++ Категория";
	AL["4+++ kata"] = "4+++ Категория";
	AL["4++++ kata"] = "4++++ Категория";
	AL["3 kata"] = "3 Категория";
	AL["3+ kata"] = "3+ Категория";
	AL["3++ kata"] = "3++ Категория";
	AL["3+++ kata"] = "3+++ Категория";
	AL["3++++ kata"] = "3++++ Категория";
	AL["3+++++ kata"] = "3+++++ Категория";
	AL["2 kata"] = "2 Категория";
	AL["2+ kata"] = "2+ Категория";
	AL["2++ kata"] = "2++ Категория";
	AL["2+++ kata"] = "2+++ Категория";
	AL["2++++ kata"] = "2++++ Категория";
	...
	AL["ALMR1"] = "Получено ";
	AL["ALMR2"] = "  |cffFF8400(";
	AL["ALMR3"] = ")|r  |cffFFFFFFШанс: ";
	AL["ALMR4"] = "|r  |cffFFFFFFШанс: ";
	AL["Dalaran"] = "Даларан";
	...
	AL["BMarketPets"] = "Питомцы";
	AL["BMarketTabards"] = "Накидки";
	AL["BMarketShirts"] = "Рубашки";
	AL["BMarketEquip"] = "Экипировка";
	AL["BMarketOther"] = "Прочее";
	AL["BMarketRecipes"] = "Рецепты";

	AL["pigment"] = "Полироль";
    AL["pigmentruby"] = "Красная мистическая полироль";
	AL["pigmentsapphire"] = "Синяя мистическая полироль";
	AL["pigmentgolden"] = "Желтая мистическая полироль";
	AL["pigmentindigo"] = "Фиолетовая мистическая полироль";
	...
	AL["Perfectgolden"] = "Идеальный алицит";
	AL["Perfectindigo"] = "Идеальный камень ночи";
	AL["Perfectemerald"] = "Идеальная яшма";
	AL["Perfectburnt"] = "Идеальный гессонит";
    ...
    AL["Reset Quicklooks"] = "Сброс Быстрого Осмотра";
    ...
    AL["Lootlink Tooltips"] = "Всплывающие подсказки Ссылок-Трофеев";
    AL["|cff9d9d9dLootlink Tooltips|r"] = "|cff9d9d9dПодсказки Ссылок-Трофеев|r";
    ...
    AL["Classic Style"] = "Классика";
    AL["BC Style"] = "Пылающий Поход";
    AL["Wotlk Style"] = "Нордскол";
    AL["Cataclysm Style"] = "Катаклизм";
    AL["Pandaria Style"] = "Пандария";
    AL["Draenor Style"] = "Дренор";
    AL["Legion Style"] = "Легион";
    AL["Default Style"] = "Стандартный стиль";
    AL["Old Style"] = "Старый стиль";
	...
	AL["SIRUSCHESTMOUNTMENU"] = "Зачарованная шкатулка верховых животных";
	AL["SIRUSLEGENDARYBACK"] = "Плащи";
	AL["SIRUSMOUNT"] = "Ездовые животные";
	AL["SIRUSPET"] = "Небоевые питомцы";
	AL["Elisandr"] = "Транспорт Элисандра";
	AL["SIRUSARENAMOUNT"] = "PVP транспорт";
	AL["TailorSign"] = "Портняжное дело";
	AL["EnchanterSign"] = "Зачарование";
	AL["AlchemySign"] = "Алхимия";
	AL["EngineerSign"] = "Инженерное дело";
	AL["SkinnerSign"] = "Кожевничество";
	AL["CookerSign"] = "Кулинария";
	AL["InscriptionSign"] = "Начертание";
	AL["MinerSign"] = "Горное дело";
	AL["ElementalSign"] = "Стихии";
	AL["JewelrySign"] = "Ювелирное дело";
	AL["TailorSign1"] = "Знак умелого портного Даларана";
	AL["TailorSign2"] = "Знак искусного портного Даларана";
	AL["TailorSign3"] = "Знак умелого портного Шаттрата";
	AL["TailorSign4"] = "Знак искусного портного Шаттрата";
	AL["TailorSign5"] = "Знак портного-мастера Шаттрата";
	AL["AlchemySign1"] = "Знак алхимика Даларана";
	AL["AlchemySign2"] = "Знак алхимика Шаттрата";
	AL["EnchanterSign1"] = "Знак искусного зачарователя Даларана";
	AL["EnchanterSign2"] = "Знак мастера чар Даларана";
	AL["EnchanterSign3"] = "Знак искусного зачарователя Шаттрата";
	AL["EnchanterSign4"] = "Знак мастера чар Шаттрата";
	AL["EngineerSign1"] = "Знак искусного инженера Даларана";
	AL["EngineerSign2"] = "Знак мастера инженерии Даларана";
	AL["EngineerSign3"] = "Знак искусного инженера Шаттрата";
	AL["EngineerSign4"] = "Знак мастера инженерии Шаттрата";
	AL["SkinnerSign1"] = "Знак умелого кожевника Даларана";
	AL["SkinnerSign2"] = "Знак искусного кожевника Даларана";
	AL["SkinnerSign3"] = "Знак мастера-кожевника Даларана";
	AL["SkinnerSign4"] = "Знак умелого кожевника Шаттрата";
	AL["SkinnerSign5"] = "Знак искусного кожевника Шаттрата";
	AL["SkinnerSign6"] = "Знак мастера-кожевника Шаттрата";
	AL["CookerSign1"] = "Знак повара Даларана";
	AL["CookerSign2"] = "Знак шеф-повара Даларана";
	AL["CookerSign3"] = "Знак повара Шаттрата";
	AL["InscriptionSign1"] = "Знак начертателя Даларана";
	AL["InscriptionSign2"] = "Знак начертателя Шаттрата";
	AL["MinerSign1"] = "Знак умелого шахтера Даларана";
	AL["MinerSign2"] = "Знак искусного шахтера Даларана";
	AL["MinerSign3"] = "Знак шахтера-мастера Даларана";
	AL["MinerSign4"] = "Знак умелого шахтера Шаттрата";
	AL["MinerSign5"] = "Знак искусного шахтера Шаттрата";
	AL["MinerSign6"] = "Знак шахтера-мастера Шаттрата";
	AL["ElementalSign1"] = "Знак призывателя стихий Даларана";
	AL["ElementalSign2"] = "Гранитный щит Лорда	Ал'акира";
	AL["ElementalSign3"] = "Воронка извечных стихий";
	AL["ElementalSign4"] = "Лист с древня Иллидановой рощи";
	AL["ElementalSign5"] = "Знак призывателя стихий Шаттрата";
	AL["ElementalSign6"] = "Слиток изначальных стихий";
	AL["ElementalSign7"] = "Око моря";
	AL["ElementalSign8"] = "Воронка изначальной магии";
	AL["JewelrySign1"] = "Знак умельца ювелира Даларана";
	AL["JewelrySign2"] = "Половинка даларанского ювелирного знака";
	AL["JewelrySign3"] = "Даларанский ювелирный осколок";
	AL["JewelrySign4"] = "Знак искусного ювелира Даларана";
	AL["JewelrySign5"] = "Половинка даларанского ювелирного знака";
	AL["JewelrySign6"] = "Даларанский ювелирный осколок";
	AL["JewelrySign7"] = "Знак мастера-ювелира Даларана";
	AL["JewelrySign8"] = "Половинка даларанского ювелирного знака";
	AL["JewelrySign9"] = "Даларанский ювелирный осколок";
	AL["JewelrySign10"] = "Знак умелого ювелира Шаттрата";
	AL["JewelrySign11"] = "Половинка Шаттратского ювелирного знака";
	AL["JewelrySign12"] = "Шаттратский ювелирный осколок";
	AL["JewelrySign13"] = "Знак искусного ювелира Шаттрата";
	AL["JewelrySign14"] = "Половинка Шаттратского ювелирного знака";
	AL["JewelrySign15"] = "Шаттратский ювелирный осколок";
	AL["JewelrySign16"] = "Знак мастера-ювелира Шаттрата";
	AL["JewelrySign17"] = "Половинка Шаттратского ювелирного знака";
	AL["JewelrySign18"] = "Шаттратский ювелирный осколок";
	...
	AL["Classic Raids"] = "Классик рейды";
    ...
    AL["Vanity Pets"] = "Небоевые питомцы";
	...
	AL["Tier 6 Sets"] = "Комплекты: Тир 6";
    ...
    AL["PvP Accessories"] = "PvP Аксессуары/Плащи/Кольца/Щея";
    AL["PvP RBG"] = "Рейтинговое поле боя";
	AL["PvP RBG Transmogrification"] = "Комплекты трансмогрификации"
	...
	-- Wishlist
	AL["MountJournalOpen"] = "Открыть в Коллекции";
	AL["Close"] = "Закрыть";
	...
	AL["Mark items in loot tables"] = "Предметы в таблице добычи";
	AL["Mark items from own Wishlist"] = "Предметы из вашего списка";
	AL["Mark items from all Wishlists"] = "Предметы из всех списков";
	AL["Enable Wishlist Sharing"] = "Позволяет делиться списками";
	AL["Auto reject in combat"] = "Авто отклонения в бою";
	AL["Always use default Wishlist"] = "Использовать список нужного по умолчанию";
	AL["Add Wishlist"] = "Добавить список нужного";
	AL["Edit Wishlist"] = "Изменить список нужного";
	...
	AL["Rating:"] = "Служба:"; -- Shorthand for 'Required Rating' for the personal/team ratings
	AL["Rank:"] = "Арена:";
	...
	AL["Tier 11 Sets"] = "Комплекты 11 тира";
    ...
    AL["BT Patterns/Plans"] = "ЧХ - Выкройки/Чертежи";
    AL["Hyjal Summit Designs"] = "Вершина Хиджала - эскизы";
    AL["SP Patterns/Plans"] = "Выкройки/Чертежи";
	AL["Ulduar Formula/Patterns/Plans"] = "Ульдуар - формулы/выкройки/чертежи";
	AL["Trial of the Crusader Patterns/Plans"] = "Испытание крестоносца - выкройки/чертежи";
    AL["Legendary Items for Kael'thas Fight"] = "Легендарные предметы для боя с Кель'тасом";
	AL["Essence of Souls"] = "Реликварий Душ";

	-- Pets
	AL["Pets"] = "Питомцы";
	AL["Promotional"] = "Содействующие";
	AL["Pet Store"] = "Магазин питомцев";
	AL["Merchant Sold"] = "Продаются торговцами";
	AL["Rare"] = "Редкий";
    ...
    AL["OtherPvPRewards"] = "Фракционные ездовые животные";
	...
	--Kloaka
	AL["WillCircle"] = "Круг Воли";

	AL["RageSaddle"] = "Седло Ярости";
    ...
    AL["Opera Event"] = "Опера";
	AL["Servant's Quarter Animal Bosses"] = "Мини-боссы в подвале";
	...
	AL["Furious Gladiator\'s Weapons"] = "Оружие гневного гладиатора"; --unused
    AL["Relentless Gladiator\'s Weapons"] = "Оружие безжалостного гладиатора"; --unused
	AL["Gladiator\'s Weapons"] = "PvP Оружие";
	AL["Vengeful Gladiator\'s Weapons"] = "Оружие бессмертного гладиатора"; --unused
	AL["Cataclysmic Gladiator\'s Weapons"] = "Оружие гладиатора Катаклизма"; --unused
    ...
    AL["JainaP"] = "Леди Джайна Праудмур";
	...
	AL["Ring of Law"] = "Арена";
	AL["Blacksmith Plans"] = "Планы ковки";
	AL["The Grim Guzzler"] = "Угрюмый обжора";
	AL["Summoner's Tomb"] = "Гробница призывателя";
	AL["Random Boss Drops"] = "Случайный дроп";
	AL["Spawn of Hakkar"] = "Порождение Хаккара";
	AL["Troll Minibosses"] = "Тролли мини-боссы";
	AL["Plans: Corruption"] = "Планы: Разложение";
	...
	AL["Need Update"] = "|cffffffffВаша версия |cff69CCF0AtlasLoot |cffffffffустарела. Ссылка для скачивания находится в: |cff00FF96Настройки|cffffffff-|cff00FF96Об аддоне.|r";
	...
	AL["How to link an item to someone else:"] = "Как передать ссылку на предмет кому-нибудь:";
	...
	AL["What else does the wishlist do?"] = "Что еще делает список желаний?";
	AL["If you Left Click any item on the wishlist, you can jump to the loot page the item comes from.  Also, on a loot page any item already in your wishlist is marked with a yellow star."] = "Если вы щелкните левой кнопкой мыши любой элемент в списке желаний, вы можете перейти на страницу добычи, с которой этот элемент приходит.  Кроме того, на странице лута любой предмет, уже находящийся в вашем списке желтых желаний, помечается желтой звездочкой.";
	...
	AL["AtlasLoot Mods"] = "Модификации";
	AL["AtlasLoot New Styles"] = "|cff9d9d9dAtlasLoot: Новые стили|r";
	AL["AtlasLoot Frame Locker"] = "|cff9d9d9dAtlasLoot: Блокировщик фрейма|r";
	AL["AtlasLoot Roulette Stat"] = "|cff9d9d9dAtlasLoot: Статистика рулетки|r";
 AL["AtlasLoot Update Info"] = "|cff9d9d9dAtlasLoot: Индикатор устаревшей версии|r";
	AL["AtlasLoot Log Items"] = "|cff9d9d9dAtlasLoot: Список полученных предметов|r";
	AL["AtlasLoot Filter Items"] = "Только оружие и доспехи";

	AL["AtlasLoot Changelog"] = "Список изменений";
	AL["AtlasLoot About"] = "Об аддоне";
	AL["AtlasLoot AboutT"] = "|cffFFD700AtlasLoot - Об аддоне";
