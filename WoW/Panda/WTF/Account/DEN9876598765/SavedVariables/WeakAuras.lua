...
WeakAurasSaved = {
	...
	["talent_cache"] = {
		...
		["WARRIOR"] = {
			...
			{
				["name"] = "Массовое отражение заклинания",
		...
		["WARLOCK"] = {
			...
			{
				["name"] = "Коварство Кил'джедена",
				["icon"] = "Interface\\Icons\\Achievement_Boss_Kiljaedan",
			}, -- [17]
			{
				["name"] = "Ярость Маннорота",
		...
		["SHAMAN"] = {
			...
			{
				["name"] = "Тотем хватки земли",
				["icon"] = "Interface\\Icons\\Spell_Nature_StrangleVines",
			}, -- [5]
			{
				["name"] = "Тотем ветроступа",
			...
			{
				["name"] = "Повелитель изначальных стихий",
