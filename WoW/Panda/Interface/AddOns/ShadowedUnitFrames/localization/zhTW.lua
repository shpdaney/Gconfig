...
L["Adds a bar indicating how much time is left on your Rune of Power."] = "新增說明條在你的符文能量剩餘多少時間。" -- Needs review
L["Adds a bar inside the health bar indicating how much damage will be absorbed."] = "增加一個條在血量條中以指示已吸收多少傷害。"
L["Adds a bar inside the health bar indicating how much healing someone will receive."] = "增加一個條在生命條中以顯示某些人將獲得多少治療。"
L["Adds a Burning Embers bar for Destruction Warlocks."] = "為毀滅術士增加燃火餘燼條"
L["Adds a Demonic Fury bar for Demonology Warlocks."] = "為惡魔術士增加惡魔之怒條"
...
L["Adds eclipse bars and how far into sun or moon eclipse is."] = "增加日月時條，並顯示日蝕或月蝕的多寡。"
...
L["Alternate power is used for things like quests and dungeons."] = "替代能量被任務和地城來使用。" -- Needs review
...
L["Banked Holy Power"] = "儲備的神聖能量"
L["Bar alpha"] = "計量調透明度"
L["Bar coloring for the moon portion of the eclipse bar."] = "蝕星蔽月條(月蝕)部份的顏色。"
L["Bar color to use to show how much healing someone is about to receive."] = "條顏色用來顯示某人收到了多少的治療。" -- Needs review
L["Bars"] = "計量條"
L["Bar spacing"] = "計量條間隔"
L["Bar texture"] = "背景材質"
L["Battleground"] = "戰場"
...
L["Bear"] = "巨熊"
L["BG"] = "戰場" -- Needs review
L["BG Pet"] = "戰場寵物" -- Needs review
L["BG Target"] = "戰場目標" -- Needs review
L["Blacklist"] = "黑名單"
...
L["Border color"] = "邊框顏色"
L["Border coloring of stealable or removable auras."] = "為可偷取或驅散的Buff/Debuff外框染色"
...
L["Buffs"] = "增益"
L["Burning Embers"] = "燃燒餘燼"
L["Burning Embers bar"] = "燃燒餘燼條"
L["C"] = "C"
...
L["|cffff2020Warning!|r Some units have overrides set in zone configuration, and may show (or not show up) in certain zone. Regardless of the settings below."] = "|cffff2020警告!|r 某些單位在地區設定已複寫設定，可能顯示(或不顯示)在某些地區。 不理會以下設定。"
...
L["Color to use to show how much damage will be absorbed."] = "顏色用來顯示有多少傷害被吸收了。" -- Needs review
...
L["Cur/Max power (Monk)"] = "目前/最大能量 (武僧)"
...
L["Current Demonic Fury (Short)"] = "目前的惡魔之怒(簡短)"
L["Current health (Druid/Absolute)"] = "當前生命值 (德魯伊/完整)"
L["Current health (Monk/Absolute)"] = "目前生命值 (武僧/絕對值)"
...
L["Current power (Monk)"] = "目前能量 (武僧)"
L["Current power (Monk/Absolute)"] = "目前能量 (武僧/絕對值)"
...
L["Dungeon Role"] = "地城角色"
L["Eclipse bar"] = "蝕星蔽月條"
L["Eclipse (Druid)"] = "日月蝕(德魯依)"
L["Eclipse (Moon)"] = "蝕星蔽月(月蝕)"
L["Eclipse (Sun)"] = "蝕星蔽月(日蝕)"
L["Edge size"] = "邊緣大小"
L["Editing %s"] = "正在編輯%s"
L["Edit tag"] = "編輯標籤"
L["Elite"] = "精英"
...
L["Green (<30% HP)"] = "綠色(<30%HP)" -- Needs review
L["Group by"] = "小隊依照"
L["Group %d"] = "小隊 %d"
L["Group number"] = "小隊"
...
L["How many Shadow Orbs you have if you're Shadow"] = "你有多少的暗影寶珠，如果你是暗牧"
...
L["Incoming absorbs"] = "承受的吸收" -- Needs review
...
L["Max columns"] = "最大列數量"
L["Max Demonic Fury (Short)"] = "最大惡魔之怒(簡短)"
...
L["Monk mana bar"] = "武僧法力條"
L["Monochrome"] = "單色"
L["Moonkin"] = "梟獸"
L["Mushroom bar"] = "蘑菇動作條"
L["Mushrooms"] = "蘑菇"
L["Name"] = "名稱"
...
L["Percent Demonic Fury"] = "惡魔之怒百分比"
L["Percent HP"] = "百分比生命值"
...
L["Red (>70% HP)"] = "紅色(>70%HP)" -- Needs review
...
L["Shows a bar for alternate power info (used in some encounters)"] = "顯示替代的能量條資訊(使用在一些遭遇中)"
...
L["Shows the mana power bar for Mistweaver Monks."] = "顯示織霧者武僧的法力條。"
...
L["Statue bar"] = "雕像條"
L["Status"] = "狀態"
L["Status indicator, shows if the unit is currently in combat. For the player it will also show if you are rested."] = "狀態指示器，如果單位目前戰鬥中時顯示。如果你已重置也會被顯示。"
L["Stealable or Removable"] = "可偷取或可移動的"
...
L["Whitelists"] = "白名單"
L["Whitelists will hide any aura not in the filter group.|nBlacklists will hide auras that are in the filter group."] = "白名單將會隱藏任何不在過濾群組的光環。/n黑名單將會隱藏在過濾群組的光環。"
L["Width"] = "寬"
...
L["You can find more information on creating your own custom tags in the \"Help\" tab above.|nSUF will attempt to automatically detect what events your tag will need, so you do not generally need to fill out the events field."] = "你可以在創建你自己自訂在\"幫助\"標籤之上的標籤找到更多資訊。|nSUF將自動嘗試來檢查那些事件你的標籤會需要，所以你通常不需要填寫事件欄位。"
