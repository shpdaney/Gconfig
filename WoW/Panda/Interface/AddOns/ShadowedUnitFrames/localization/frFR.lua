...
L["Absolute incoming heal value, if 10,000 healing is incoming it will show 10,000."] = "Valeur absolue des soins entrants. Si un soin à 10 000 arrive, 10 000 sera affiché." -- Needs review
L["Add"] = "Ajouter"
L["Add aura"] = "Ajouter aura" -- Needs review
L["Add Aura"] = "Ajouter aura" -- Needs review
L["- Added absorb shield tags"] = "- Ajout de tags pour boucliers d'absorption" -- Needs review
L["- Added Ancient Kings bar for Paladins"] = "-  Ajout d'une barre Anciens Rois pour les Paladins" -- Needs review
...
L["Adds rune bars and timers before runes refresh to the player frame."] = "Ajoute une barre des runes avec les compteurs de recharge des runes au cadre du joueur." -- Needs review
...
L["Adds totem bars with timers before they expire to the player frame."] = "Ajoute des barres de totem avec des compteurs d'expiration au cadre du joueur." -- Needs review
...
L["AFK timer"] = "Durée ABS" -- Needs review
...
L["- And more! See the change log for everything that has changed."] = "- Et plus ! Voir l'historique pour connaître tous les changements." -- Needs review
...
L["As of SUF v3.10, a bunch of new features and units have been added.|n"] = "A partir de SUF v3.10, un nombre de nouvelles fonctions et unités ont été ajoutées.|n" -- Needs review
...
L["- Aura config is no longer a bunch of clumped options"] = "-  La config d'auras n'est plus un tas d'options en vrac" -- Needs review
...
L["Aura Indicators"] = "Indicateurs d'aura" -- Needs review
L["- Aura Indicators are now built in"] = "- Les indicateurs d'auras sont intégrés" -- Needs review
L["Aura name"] = "Nom de l'aura"
L["Auras"] = "Auras"
L["- Auras can be filtered multiple criteria rather than just self casted"] = "- Les auras peuvent être filtrées selon plusieurs critères" -- Needs review
...
L["- Auto profile switching based on dual spec is available in /suf -> Profile"] = "- Changement de profil selon la double spécialisation disponible dans /suf -> Profil" -- Needs review
L["B"] = "B"
...
L["- Boss debuff filtering is in"] = "- Ajout du filtrage des affaiblissements des boss" -- Needs review
...
L["- Boss ToT, Main Assist ToT, Main Tank ToT, Party ToT, Battleground ToT and Arena ToT units have been added!"] = "- Cible de la Cible pour les Boss, Soutiens Principaux, Tanks Principaux, Groupe, Champ de bataille et Arène ajoutés !" -- Needs review
...
L["Both"] = "Les deux"
L["Bottom"] = "Bas" -- Needs review
L["Bottom Center"] = "Bas Centre" -- Needs review
L["Bottom Left"] = "Bas Gauche" -- Needs review
L["Bottom Right"] = "Bas Droite" -- Needs review
...
L["- Config UI now opens instantly, and does not take 5 seconds++ to show up!"] = "- L'interface de config s'ouvre instantanément, et ne prend plus 5 secondes++ pour s'afficher !" -- Needs review
L["Configuration to specific unit frames."] = "Configuration de cadres d'unité spécifiques."
L["- Cooldown rings and scaled auras are more configurable"] = "- Spirale de recharge et échelle des auras ont plus d'options" -- Needs review
...
L["Dismissable totems bars"] = "Barre de totems renvoyables." -- Needs review
...
L["- Highlight based on unit rare/elite is now available"] = "- Mise en surbrillance des unités rare/élite maintenant disponible" -- Needs review
...
L["- Monk Stagger now shows the amount of staggered damage"] = "- Le Report des Moines montre la quantité de dégâts reportés" -- Needs review
...
L["|nYou can disable the new text for Monk Stagger, Totem and Rune timers through /suf -> Unit configuration -> Text/Tags"] = "|nVous pouvez désactiver le nouveau texte pour le Report des Moines, les compteurs de Totems et de Runes avec /suf -> Configuration d'unité -> Texte/Tags" -- Needs review
...
L["Removable"] = "Enlevable" -- Needs review
L["Removable/Stealable"] = "Enlevable/Volable" -- Needs review
...
L["- Totem/Rune bars now have timers indicating time to refres/expire"] = "- Les barres de Totems/Runes ont désormais des compteurs indiquant le temps de recharge/expiration" -- Needs review
...
L["Welcome to Shadowed Unit Frames v4! Auras have been expanded in this release.|n"] = "Bienvenue dans Shadowed Unit Frames v4 ! Les auras ont été développées dans cette version.|n" -- Needs review
