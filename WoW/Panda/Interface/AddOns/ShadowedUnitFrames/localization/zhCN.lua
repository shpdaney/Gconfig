...
L["Absolute damage absorption value on the unit, if 10,000 damage will be absorbed, it will show 10,000."] = "在单位上显示伤害吸收的绝对值, 如果10000的伤害被吸收, 将会显示为10000." -- Needs review
L["Absolute heal absorb value, if 16,000 healing will be absorbed, it will show 16,000."] = "治疗吸收绝对值, 如果16000的治疗量被吸收, 显示为16000." -- Needs review
L["Absolute incoming heal value, if 10,000 healing is incoming it will show 10,000."] = "精确显示接受治疗的治疗量, 如 10,000 治疗量显示为 10,000."
L["Add"] = "增加"
L["- Added absorb shield tags"] = "- 添加了吸收护盾标签" -- Needs review
L["- Added Ancient Kings bar for Paladins"] = "- 为圣骑士添加了远古诸王条" -- Needs review
...
L["Adds a bar indicating how much time is left on your Rune of Power."] = "添加状态条显示符文能量还有剩余多长时间" -- Needs review
L["Adds a bar inside the health bar indicating how much damage will be absorbed."] = "在生命条里增加一个状态条显示将会有多少伤害量会被吸收" -- Needs review
L["Adds a bar inside the health bar indicating how much healing someone will receive."] = "在血量条里添加一个显示受到任何治疗量的指示条." -- Needs review
L["Adds a bar inside the health bar indicating how much healing will be absorbed and not applied to the player."] = "在血量条里增加一条用于显示有多少治疗量被吸收而没有作用于玩家身上." -- Needs review
L["Adds a Burning Embers bar for Destruction Warlocks."] = "为毁灭术士添加一个爆燃灰烬条." -- Needs review
L["Adds a Demonic Fury bar for Demonology Warlocks."] = "为恶魔术士添加一个恶魔怒气条." -- Needs review
...
L["Adds a Stagger bar for Brewmaster Monks."] = "为酒仙武僧增加一个醉拳状态条显示醉拳化解伤害计时" -- Needs review
L["Adds eclipse bars and how far into sun or moon eclipse is."] = "添加一个日食条显示到日蚀或月蚀的距离." -- Needs review
...
L["Allows you to disable the totem by right clicking it.|n|nWarning: Inner bars for this unit will not resize in combat if you enable this."] = "允许通过右键点击它禁用图腾.|n|n警告: In如果你启用它,则单元附近的状态条无法在战斗中调整大小." -- Needs review
L["Alpha to use for bar."] = "计量条要使用的透明度."
L["Alpha to use for bar backgrounds."] = "计量条背景所使用的透明度."
L["Alternate power is used for things like quests and dungeons."] = "特定能量用于像任务或者副本等情况下." -- Needs review
L["Alt. Power"] = "特定能量" -- Needs review
...
L["Ancient Kings bar"] = "远古诸王条" -- Needs review
L["- And more! See the change log for everything that has changed."] = "- 等等! 所有的改变请看change log." -- Needs review
L["Aquatic"] = "水栖"
L["Arena"] = "竞技场"
L["Arena Pet"] = "竞技场宠物"
L["Arenas"] = "竞技场"
L["Arena Target"] = "竞技场目标"
L["Arena Target of Target"] = "竞技场目标的目标" -- Needs review
L["Arena ToT"] = "竞技场ToT" -- Needs review
...
L["Ascending"] = "上升"
L["As of SUF v3.10, a bunch of new features and units have been added.|n"] = "伴随SUF3.10版, 一些新功能和单位被添加进来.|n" -- Needs review
L["Assigned Role (DPS/Tank/etc)"] = "职责分配(DPS/坦克/等等..)" -- Needs review
L["Aura borders"] = "光环边框" -- Needs review
L["Aura border style"] = "光环边框样式"
L["Aura Combo Points"] = "光环连击点" -- Needs review
L["Aura filters"] = "光环过滤器"
L["Aura Filters"] = "光环过滤器" -- Needs review
L["Aura name"] = "光环名字"
L["Auras"] = "光环"
L["Aura types to filter"] = "要过滤的光环类型"
L["- Auto profile switching based on dual spec is available in /suf -> Profile"] = "- 在/suf -> 配置文件里,在有dual spec库文件的支持下,自动切换配置文件是可以用的" -- Needs review
L["B"] = "B"
L["Background"] = "背景"
...
L["Bars"] = "计量条"
L["Bar spacing"] = "计量条间距"
L["Bars with an order higher or lower than the full size options will use the entire unit frame width.|n|nBar orders between those two numbers are shown next to the portrait."] = "条顺序高于或低于全尺寸选项会使用整个单位框架的宽度. |n|n条显示在两个数字之间的头像旁." -- Needs review
L["Bar texture"] = "背景材质"
L["Battleground"] = "战场" -- Needs review
L["Battleground Pet"] = "战场宠物" -- Needs review
L["Battlegrounds"] = "战场"
L["Battleground Target"] = "战场目标" -- Needs review
L["Battleground Target of Target"] = "战场目标的目标" -- Needs review
L["Bear"] = "熊"
L["BG"] = "战场" -- Needs review
L["BG Pet"] = "战场宠物" -- Needs review
L["BG Target"] = "战场目标" -- Needs review
L["BG ToT"] = "战场ToT" -- Needs review
L["Blacklist"] = "黑名单"
...
L["Border color"] = "边框颜色"
L["Border coloring of stealable or removable auras."] = "为可偷取或驱散的光环边框着色" -- Needs review
L["Border highlighting"] = "边框高亮"
L["Border thickness"] = "边框厚度"
L["Boss"] = "首领"
L["Boss Target"] = "首领目标"
L["Boss Target of Target"] = "首领目标的目标" -- Needs review
L["Boss ToT"] = "首领ToT" -- Needs review
L["- Boss ToT, Main Assist ToT, Main Tank ToT, Party ToT, Battleground ToT and Arena ToT units have been added!"] = "- 添加了首领ToT, 副坦ToT, 主坦ToT, 小队ToT, 战场ToT 和竞技场ToT 单位! (ToT为目标的目标)." -- Needs review
...
L["Buffs"] = "Buff"
L["Burning Embers"] = "爆燃灰烬" -- Needs review
L["Burning Embers bar"] = "爆燃灰烬条" -- Needs review
L["C"] = "C"
...
L["|cffff2020Warning!|r Some units have overrides set in zone configuration, and may show (or not show up) in certain zone. Regardless of the settings below."] = "|cffff2020Warning!|r 在区域配置中有些单元的覆盖设置, 在某些区域可能显示(或不显示). 都不会受下列设置影响." -- Needs review
...
L["Class (Smart)"] = "职业 (简洁)"
L["Class Specific"] = "特定职业" -- Needs review
L["Class Timer"] = "职业计时器" -- Needs review
L["Clip"] = "内间距"
L["Close color"] = "关闭颜色"
...
L["Color power by"] = "着色能量依据" -- Needs review
L["Colors"] = "颜色"
L["Color to use for health bars that are set to be colored by a static color."] = "生命值设置为着色为固定颜色的生命条颜色."
L["Color to use to show how much damage will be absorbed."] = "染色显示多少伤害将会被吸收" -- Needs review
L["Color to use to show how much healing will e absorbed."] = "用颜色显示多少治疗量会被吸收" -- Needs review
...
L["Combat Status"] = "战斗状态" -- Needs review
L["Combat text"] = "战斗文字"
L["Combo points"] = "连击点数"
L["Combo Points"] = "连击点" -- Needs review
L["- Config UI now opens instantly, and does not take 5 seconds++ to show up!"] = "- 现在能瞬间打开配置界面, 不再耗费5秒多才能显示出来!" -- Needs review
...
L["Crown indicator for group leader or assistants."] = "为团长或团队助理显示一个皇冠指示器." -- Needs review
...
L["Cur/Max power (Monk)"] = "当前/最大 能量(武僧)" -- Needs review
...
L["Current Demonic Fury (Short)"] = "当前的恶魔怒气 (短)" -- Needs review
L["Current Eclipse, <0 is Lunar Energy and >0 is Solar Energy."] = "当前月食, <0 为月能 >0 为日能" -- Needs review
L["Current health (Druid/Absolute)"] = "当前生命值 (德鲁伊/绝对值)"
L["Current health (Monk/Absolute)"] = "当前血量(武僧/绝对值)" -- Needs review
...
L["Currently modifying"] = "当前修改" -- Needs review
L["Currently used in battlegrounds for showing flag carriers."] = "当前用于在战场中显示旗帜携带者." -- Needs review
L["Current power (Absolute)"] = "当前能力值 (绝对值)"
L["Current power (Druid)"] = "当前能力值 (德鲁伊)"
L["Current power (Druid/Absolute)"] = "当前能力值 (德鲁伊/绝对值)"
L["Current power (Monk)"] = "当前能量(武僧)" -- Needs review
L["Current power (Monk/Absolute)"] = "当前能量(武僧/绝对值)" -- Needs review
...
L["Damage absorption (Absolute)"] = "伤害吸收 (绝对值)" -- Needs review
L["Damage absorption/Name"] = "伤害吸收/名字" -- Needs review
L["Damage absorption (Short)"] = "伤害吸收 (缩写)" -- Needs review
L["Dark"] = "深色"
L["Dead"] = "死亡"
L["Debuffs"] = "Debuff"
...
L["Demonic Fury"] = "恶魔怒气" -- Needs review
L["Demonic Fury bar"] = "恶魔怒气条" -- Needs review
L["Descending"] = "降序"
L["Disabled"] = "禁用"
...
L["Dismissable totems bars"] = "可取消图腾条" -- Needs review
L["DND"] = "勿打扰"
L["DND:%s"] = "勿打扰:%s"
...
L["Dungeon Role"] = "副本职责" -- Needs review
L["Eclipse bar"] = "月蚀条"
L["Eclipse (Druid)"] = "日食 (德鲁伊)" -- Needs review
L["Eclipse (Moon)"] = "月蚀"
L["Eclipse (Sun)"] = "日蚀"
L["Edge size"] = "边角大小"
L["Editing %s"] = "正在编辑 %s"
...
L["Enabled Units"] = "单位已启用" -- Needs review
...
L["Fel Energy"] = "恶魔能量" -- Needs review
L["Female"] = "女性"
...
L["Fuel"] = "燃料"
L["Full Burning Ember"] = "完整的爆燃灰烬" -- Needs review
...
L["Green (<30% HP)"] = "绿色(<30% 生命值)" -- Needs review
L["Group by"] = "分组按"
L["Group %d"] = "队伍 %d"
L["Group number"] = "队伍数字"
...
L["Guild name"] = "公会名字"
L["Half health"] = "半血"
L["Has Aggro"] = "获得仇恨" -- Needs review
L["Heal absorb"] = "治疗吸收" -- Needs review
L["Heal Absorb (Absolute)"] = "治疗吸收(绝对值)" -- Needs review
L["Heal absorbs"] = "吸收治疗" -- Needs review
L["Heal Absorb (Short)"] = "治疗吸收(缩写)" -- Needs review
L["Healing absorb"] = "吸收治疗" -- Needs review
L["Health"] = "生命"
L["Health bar"] = "生命条"
...
L["Health bar color for units with aggro."] = "血量条着色显示获得仇恨" -- Needs review
...
L["High health"] = "高生命值"
L["Highlight"] = "高亮"
L["- Highlight based on unit rare/elite is now available"] = "- 现在可高亮显示稀有/精英单位" -- Needs review
L["Highlight units that are "] = "高亮单位是" -- Needs review
L["Highlight units that are debuffed with something you can cure."] = "高亮你可以治愈的被施放了Debuff的头像框体."
L["Highlight units that are rare."] = "高亮单位是稀有." -- Needs review
...
L["How many Chi points you currently have."] = "显示你当前有多少气点数" -- Needs review
...
L["How many seconds a totem has left before disappearing."] = "圖騰在消失之前還剩下多少秒數。" -- Needs review
L["How many seconds before a rune recharges."] = "距符文再次开始冲能有多少秒时间" -- Needs review
...
L["How many Shadow Orbs you have if you're Shadow"] = "如果你是暗牧显示你有多少暗影宝珠" -- Needs review
...
L["If the unit has a damage absorption shield on them, it will show the absolute absorb value, otherwise the units name."] = "如果单位拥有伤害吸收护盾, 它会显示吸收的绝对值, 否则显示单位名称." -- Needs review
...
L["Incoming absorb"] = "收到的吸收" -- Needs review
L["Incoming absorbs"] = "受到的吸收" -- Needs review
L["Incoming heal"] = "接受的治疗"
L["Incoming heal (Absolute)"] = "接受的治疗(绝对值)"
L["Incoming heal/Name"] = "接受治疗/名字"
L["Incoming heal (Percent)"] = "受到的治疗(百分比)" -- Needs review
...
L["Leader / Assist"] = "团长 / 团队助理" -- Needs review
L["Left"] = "左边"
L["Left Bottom"] = "左边底部"
L["Left Center"] = "左边居中"
L["Left text"] = "左边文字"
...
L["Main Assist Target of Target"] = "主助理目标的目标" -- Needs review
L["Main Tank"] = "主坦克"
L["Main Tank's are set through the Raid frames, or through selecting the Tank role."] = "主坦克是通过团队界面, 或者通过选择坦克职责来设定." -- Needs review
L["Main Tank Target"] = "主坦克目标"
L["Main Tank Target of Target"] = "主坦目标的目标" -- Needs review
L["Male"] = "男性"
L["Mana"] = "法力"
L["Manage Aura Filters"] = "管理光环过滤器" -- Needs review
L["Management"] = "管理"
L["Manual position"] = "自定义位置"
L["Master Looter"] = "队长分配" -- Needs review
L["MA ToT"] = "主助理 ToT" -- Needs review
L["Max columns"] = "最大列数量"
L["Max Demonic Fury (Short)"] = "最大恶魔怒气 (短)" -- Needs review
...
L["None"] = "无"
L["NPCs only"] = "仅NPC"
L["|nYou can disable the new text for Monk Stagger, Totem and Rune timers through /suf -> Unit configuration -> Text/Tags"] = "|n通过/suf ->头像配置子项 -> 文本/标签, 你可以禁用武僧醉拳, 图腾和符文计时器的新文本提示." -- Needs review
L["Offline"] = "离线"
...
L["On elite mobs"] = "在精英目标上" -- Needs review
L["On mouseover"] = "在鼠标悬停"
L["On rare mobs"] = "在稀有目标上" -- Needs review
L["Order"] = "顺序"
L["Or you can set a position manually"] = "或者你可以手动设置位置"
L["Other Party/Phase Status"] = "其他小队/镜像状态" -- Needs review
L["Outline"] = "描边"
L["Out of range alpha"] = "超出距离透明度"
L["Outside bar limit"] = "外围计量条限制"
L["Override background"] = "覆盖背景" -- Needs review
...
L["Party Pet"] = "小队宠物"
L["Party Target"] = "小队目标"
L["Party Target of Target"] = "小队目标的目标" -- Needs review
L["Party ToT"] = "小队ToT" -- Needs review
L["Percentage of width the portrait should use."] = "肖像使用的宽度百分比."
L["Percentage value of how far outside the unit frame the absorbed health bar can go. 130% means it will go 30% outside the frame, 100% means it will not go outside."] = "治疗吸收条超出单位框架的百分比. 130%表示会超出单位框架30%, 100%表示不会超出框架." -- Needs review
L["Percentage value of how far outside the unit frame the incoming absorb bar can go. 130% means it will go 30% outside the frame, 100% means it will not go outside."] = "百分比数值显示超多少头像框架的吸收伤害条。 130%就是说会超出框架的30%。 100%就是说不会超出。" -- Needs review
...
L["Percent Demonic Fury"] = "恶魔怒气百分比" -- Needs review
L["Percent HP"] = "百分比生命值"
L["Percent of the players current health that's being healed, if they have 100,000 total health and 15,000 is incoming then 15% is shown."] = "玩家当前受到的治疗量占总血量的百分比, 假如他有100000总血量并且受到15000的治疗量那么显示为15%." -- Needs review
L["Percent power"] = "百分比能力值"
L["Per column"] = "每栏"
L["Per row"] = "每行"
L["Pet"] = "宠物"
L["Pet Battle"] = "宠物战斗" -- Needs review
L["Pet Target"] = "宠物目标"
L["Player"] = "玩家"
L["player alt. power"] = "玩家特殊能力条"
L["player cast bar"] = "玩家施法条"
L["player power frames"] = "玩家能量框体" -- Needs review
L["Players only"] = "仅玩家"
...
L["Power"] = "能力"
L["Power bar"] = "能力条"
L["Power Type"] = "能量类型" -- Needs review
...
L["Primary means of coloring the power bar. Coloring by class only applies to players, for non-players it will default to the power type."] = "主要指的是能量条的着色. 按职业着色仅适用于玩家, 对于非玩家则用默认能量类型." -- Needs review
...
L["PVP:%s"] = "PVP：%s"
L["PVP timer"] = "PVP 计时器"
L["Quest Boss"] = "任务Boss" -- Needs review
L["Race"] = "种族"
L["Race (Smart)"] = "种族 (简洁)"
L["Rage"] = "怒气"
L["Raid"] = "团队"
...
L["Rather than bars filling from left -> right, they will fill from bottom -> top."] = "条的增长方向并非是从左-->右, 而是从下-->上." -- Needs review
...
L["Ready Status"] = "就绪状态" -- Needs review
L["Ready status of group members."] = "队伍成员的就绪状态."
L["Red (>70% HP)"] = "红色(>70% 生命值)" -- Needs review
L["Relative point"] = "相对定位"
L["Resources"] = "来源"
L["Resurrect Status"] = "复活状态" -- Needs review
...
L["Reverse fill"] = "反向增长" -- Needs review
L["Right"] = "右边"
L["Right Bottom"] = "右边底部"
L["Right Center"] = "右边居中"
L["Right text"] = "右边文字"
...
L["Row offset"] = "行坐标"
L["Rune bar"] = "符文条"
L["Rune of Power"] = "符文能量" -- Needs review
L["Rune of Power bar"] = "符文能量条" -- Needs review
L["Rune Timer"] = "符文计时器" -- Needs review
L["Runic Power"] = "符文能量"
...
L["Scale for auras that you casted or can Spellsteal, any number above 100% is bigger than default, any number below 100% is smaller than default."] = "缩放你释放的或可以法术偷取的光环, 任何100%以上的数值为大于默认, 任何100%以下的数值为小于默认." -- Needs review
L["Screen"] = "屏幕"
L["Search"] = "搜索"
L["Search tags"] = "搜寻标签"
...
L["Set Filter Zones"] = "局部过滤设置" -- Needs review
L["Sex"] = "性别"
L["%s frames"] = "%s 框体"
L["Shadow Orbs"] = "暗影宝珠" -- Needs review
L["Short classification"] = "短的职业类别显示"
L["Short classifications, R for Rare, R+ for Rare Elite, + for Elite, B for Boss or M for Minion nothing is shown if they aren't any of those."] = "怪物简称分类, 稀有为R, 稀有精英为R+, 精英为+, Boss为B, 爪牙为M, 不包含在这些当中的什么都不显示." -- Needs review
L["Short elite indicator"] = "短的精英指示器"
L["Shorten damage absorption, if 13,000 damage will e absorbed, it will show 13k."] = "简写伤害吸收, 如果13000的伤害被吸收, 将会显示为13k." -- Needs review
L["Shorten heal absorb value, if 17,000 healing will be absorbed, it will show 17k."] = "简化治疗吸收值, 如果17000的治疗量被吸收, 则显示为17k." -- Needs review
...
L["Show Heal Absorbs"] = "显示治疗吸收值" -- Needs review
L["Show icon durations"] = "显示图标持续时间" -- Needs review
L["Show incoming absorbs"] = "显示受到的吸收" -- Needs review
L["Show incoming heals"] = "显示受到的治疗" -- Needs review
...
L["Shows that a NPC is a boss for a quest."] = "为任务把Boss显示为任务NPC." -- Needs review
L["Shows the absolute staggered damage, if 16,000 damage is staggered, shows 16,000."] = "显示醉拳化解伤害的绝对值, 如果化解了16000的伤害, 显示为16000." -- Needs review
L["Shows the current staggered damage, if 12,000 damage is staggered, shows 12k."] = "显示醉拳当前化解的伤害, 如果化解了12000的伤害, 显示为12k." -- Needs review
L["Shows the mana power bar for Mistweaver Monks."] = "为织雾武僧显示法力条" -- Needs review
...
L["Shows what kind of pet the unit is for pet battles."] = "宠物战斗中显示单位是哪种宠物" -- Needs review
L["Shows when a party member is in a different phase or another group."] = "显示一个小队成员在不同的镜像里或其他小组中." -- Needs review
...
L["Stagger"] = "醉拳" -- Needs review
L["Stagger bar"] = "醉拳状态条" -- Needs review
L["Stagger bar color when the staggered amount is <30% of your HP."] = "当你的生命值<30%时 醉拳状态条的颜色" -- Needs review
L["Stagger bar color when the staggered amount is >30% of your HP."] = "当你的生命值>30%时 醉拳状态条的颜色" -- Needs review
L["Stagger bar color when the staggered amount is >70% of your HP."] = "当你的生命值>70%时 醉拳状态条的颜色" -- Needs review
L["Stagger (Monk)"] = "醉拳(武僧)" -- Needs review
L["Stagger (Monk/Absolute)"] = "醉拳(武僧/绝对值)" -- Needs review
L["Static"] = "静态"
L["Statue"] = "雕像" -- Needs review
L["Statue bar"] = "雕像条" -- Needs review
L["Status"] = "状态"
...
L["Stealable or Removable"] = "可偷取或可驱散" -- Needs review
...
L["Test spell"] = "测试法术"
L["Text"] = "文字"
L["Text Management"] = "文字管理" -- Needs review
L["Text name"] = "文字名字"
...
L["This is a good guide on how to get started with programming in Lua, while you do not need to read the entire thing it is a helpful for understanding the basics of Lua syntax and API's."] = "这是一个如何开始Lua编程的很好的指南, 然而你并不需要阅读整个事情, 它有助于了解Lua的语法和API的基础知识." -- Needs review
...
L["Tile size"] = "标题大小"
L["Timer Text"] = "计时器文字" -- Needs review
L["Top"] = "顶部"
L["Top Center"] = "顶部居中"
L["Top Left"] = "顶部靠左"
L["Top Right"] = "顶部靠右"
...
L["Totem bar"] = "图腾条"
L["- Totem/Rune bars now have timers indicating time to refres/expire"] = "- 图腾/符文条现在有计时器指示刷新/到期时间" -- Needs review
L["Totem Timer"] = "图腾计时器" -- Needs review
L["Travel"] = "旅行"
L["Tree"] = "树"
...
L["Unit Configuration"] = "单元配置" -- Needs review
L["Unit faction"] = "单位阵营"
L["Unit name"] = "单位名字"
...
L["Units classification, Rare, Rare Elite, Elite, Boss or Minion nothing is shown if they aren't any of those."] = "怪物分类为, 稀有,稀有精英,精英,Boss或爪牙, 不包含在这些当中的什么都不显示." -- Needs review
...
L["Uses the icon of the totem being shown instead of a status bar."] = "使用图腾图标显示代替状态条." -- Needs review
...
L["Vehicle"] = "载具"
L["Vehicles"] = "垂直"
L["Vertical growth"] = "垂直增长" -- Needs review
L["View"] = "查看"
L["Visibility"] = "可见性"
...
L["Widget Size"] = "小部件调整" -- Needs review
L["Width"] = "宽"
L["Width percent"] = "宽度百分比"
L["Width weight"] = "宽度加权"
L["Will fill right -> left when using horizontal growth, or top -> bottom when using vertical growth."] = "当使用水平增长时为从右-->左, 使用垂直增长时为从上-->下." -- Needs review
...
L["Zone Configuration"] = "区域配置" -- Needs review
