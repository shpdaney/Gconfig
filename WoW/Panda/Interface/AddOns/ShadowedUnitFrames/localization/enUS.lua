...
L["Add aura"] = "Add aura"
L["Add Aura"] = "Add Aura"
L["- Added absorb shield tags"] = "- Added absorb shield tags"
L["- Added Ancient Kings bar for Paladins"] = "- Added Ancient Kings bar for Paladins"
...
L["Adds a Burning Embers bar for Destruction Warlocks."] = "Adds a Burning Embers bar for Destruction Warlocks."
L["Adds a Demonic Fury bar for Demonology Warlocks."] = "Adds a Demonic Fury bar for Demonology Warlocks."
...
L["Adds eclipse bars and how far into sun or moon eclipse is."] = "Adds eclipse bars and how far into sun or moon eclipse is."
...
L["- And more! See the change log for everything that has changed."] = "- And more! See the change log for everything that has changed."
...
L["As of SUF v3.10, a bunch of new features and units have been added.|n"] = "As of SUF v3.10, a bunch of new features and units have been added.|n"
...
L["- Aura config is no longer a bunch of clumped options"] = "- Aura config is no longer a bunch of clumped options"
...
L["Aura Indicators"] = "Aura Indicators"
L["- Aura Indicators are now built in"] = "- Aura Indicators are now built in"
L["Aura name"] = "Aura name"
L["Auras"] = "Auras"
L["- Auras can be filtered multiple criteria rather than just self casted"] = "- Auras can be filtered multiple criteria rather than just self casted"
...
L["- Auto profile switching based on dual spec is available in /suf -> Profile"] = "- Auto profile switching based on dual spec is available in /suf -> Profile"
L["B"] = "B"
...
L["Banked Holy Power"] = "Banked Holy Power"
L["Bar alpha"] = "Bar alpha"
L["Bar coloring for the moon portion of the eclipse bar."] = "Bar coloring for the moon portion of the eclipse bar."
...
L["Border coloring of stealable or removable auras."] = "Border coloring of stealable or removable auras."
L["Border highlighting"] = "Border highlighting"
L["Border thickness"] = "Border thickness"
L["Boss"] = "Boss"
L["Boss Auras"] = "Boss Auras"
L["- Boss debuff filtering is in"] = "- Boss debuff filtering is in"
L["Boss Debuffs"] = "Boss Debuffs"
L["Boss Target"] = "Boss Target"
L["Boss Target of Target"] = "Boss Target of Target"
L["Boss ToT"] = "Boss ToT"
L["- Boss ToT, Main Assist ToT, Main Tank ToT, Party ToT, Battleground ToT and Arena ToT units have been added!"] = "- Boss ToT, Main Assist ToT, Main Tank ToT, Party ToT, Battleground ToT and Arena ToT units have been added!"
...
L["Combo Points"] = "Combo Points"
L["- Config UI now opens instantly, and does not take 5 seconds++ to show up!"] = "- Config UI now opens instantly, and does not take 5 seconds++ to show up!"
L["Configuration to specific unit frames."] = "Configuration to specific unit frames."
L["- Cooldown rings and scaled auras are more configurable"] = "- Cooldown rings and scaled auras are more configurable"
...
L["Cur/Max power (Monk)"] = "Cur/Max power (Monk)"
...
L["Current Demonic Fury (Short)"] = "Current Demonic Fury (Short)"
L["Current Eclipse, <0 is Lunar Energy and >0 is Solar Energy."] = "Current Eclipse, <0 is Lunar Energy and >0 is Solar Energy."
L["Current health (Druid/Absolute)"] = "Current health (Druid/Absolute)"
L["Current health (Monk/Absolute)"] = "Current health (Monk/Absolute)"
...
L["Current power (Monk)"] = "Current power (Monk)"
L["Current power (Monk/Absolute)"] = "Current power (Monk/Absolute)"
...
L["Demonic Fury bar"] = "Demonic Fury bar"
...
L["Dismissable totems bars"] = "Dismissable totems bars"
L["Display"] = "Display"
L["DND"] = "DND"
L["DND:%s"] = "DND:%s"
...
L["Eclipse bar"] = "Eclipse bar"
L["Eclipse (Druid)"] = "Eclipse (Druid)"
L["Eclipse (Moon)"] = "Eclipse (Moon)"
L["Eclipse (Sun)"] = "Eclipse (Sun)"
...
L["Fuel"] = "Fuel"
L["Full Burning Ember"] = "Full Burning Ember"
...
L["- Highlight based on unit rare/elite is now available"] = "- Highlight based on unit rare/elite is now available"
...
L["How many Shadow Orbs you have if you're Shadow"] = "How many Shadow Orbs you have if you're Shadow"
...
L["Max Demonic Fury (Short)"] = "Max Demonic Fury (Short)"
...
L["Monk mana bar"] = "Monk mana bar"
L["- Monk Stagger now shows the amount of staggered damage"] = "- Monk Stagger now shows the amount of staggered damage"
...
L["|nYou can disable the new text for Monk Stagger, Totem and Rune timers through /suf -> Unit configuration -> Text/Tags"] = "|nYou can disable the new text for Monk Stagger, Totem and Rune timers through /suf -> Unit configuration -> Text/Tags"
L["Offline"] = "Offline"
...
L["Percent Demonic Fury"] = "Percent Demonic Fury"
...
L["Removable/Stealable"] = "Removable/Stealable"
...
L["Show consolidable auras"] = "Show consolidable auras"
...
L["Shows the mana power bar for Mistweaver Monks."] = "Shows the mana power bar for Mistweaver Monks."
...
L["Stealable or Removable"] = "Stealable or Removable"
...
L["- Totem/Rune bars now have timers indicating time to refres/expire"] = "- Totem/Rune bars now have timers indicating time to refres/expire"
...
L["Welcome to Shadowed Unit Frames v4! Auras have been expanded in this release.|n"] = "Welcome to Shadowed Unit Frames v4! Auras have been expanded in this release.|n"
...
L["Whether to show any auras that would be consolidated by the default UI."] = "Whether to show any auras that would be consolidated by the default UI."
...
L["Works the same as [%s], but this is only shown if you are a Mistweaver Monk."] = "Works the same as [%s], but this is only shown if you are a Mistweaver Monk."
L["Works the same as [%s], but this is usedd to show Demonic Fury power for Demonology Warlocks."] = "Works the same as [%s], but this is usedd to show Demonic Fury power for Demonology Warlocks."
